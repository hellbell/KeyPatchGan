...
def set_mask(p1,p2,p3,i, output_size):
    mask = np.zeros([output_size, output_size, 1], dtype=np.int32)
...
def get_image(image_path, isFlip, image_size, is_crop=True, resize_w=64):
    return transform(imread(image_path), isFlip, image_size, is_crop, resize_w)
